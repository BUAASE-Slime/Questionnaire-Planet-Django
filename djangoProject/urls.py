...
urlpatterns = [
    ...
    path('api/pt/swagger/', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
    path('api/pt/docs/', schema_view.with_ui('redoc', cache_timeout=0), name='schema-redoc'),

    path('api/pt/admin/', admin.site.urls),
    path('api/pt/user/', include(('userinfo.urls', 'userinfo'))),
